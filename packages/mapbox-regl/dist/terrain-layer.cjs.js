...
function () {
  ...
  TerrainLayer.prototype.createTerrain = function () {
    this.map.addSource(this.terrainSource, tslib.__assign(tslib.__assign({}, this.tileJson), {
  ...
  TerrainLayer.prototype.createTile = function () {
    if (!this.map) return;
    this.map.addSource(this.source, tslib.__assign(tslib.__assign({}, this.tileJson), {
...
//# sourceMappingURL=terrain-layer.cjs.js.map
