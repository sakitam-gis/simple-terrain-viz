...
function () {
  ...
  TerrainLayer.prototype.createTerrain = function () {
    this.map.addSource(this.terrainSource, __assign(__assign({}, this.tileJson), {
  ...
  TerrainLayer.prototype.createTile = function () {
    if (!this.map) return;
    this.map.addSource(this.source, __assign(__assign({}, this.tileJson), {
...
//# sourceMappingURL=terrain-layer.esm.js.map
