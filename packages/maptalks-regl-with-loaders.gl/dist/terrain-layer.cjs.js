...
var es5 = require('@loaders.gl/core/dist/es5');
var es5$2 = require('@loaders.gl/terrain/dist/es5');
var es5$1 = require('@loaders.gl/images/dist/es5');
...
var Renderer = /** @class */ (function (_super) {
    ...
    Renderer.prototype.loadTile = function (tile) {
        ...
        if (!terrainTiles) {
            ...
            Promise.all([
                ...
                // @ts-ignore
                es5.load(tile['url'], [es5$1.ImageLoader])
            ]).then(function (_a) {
    ...
    Renderer.prototype.loadTerrain = function (_a) {
        ...
        // @ts-ignore
        return es5.load(elevationData, es5$2.TerrainLoader, options);
    };
